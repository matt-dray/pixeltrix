...
This opens an interactive, clickable plot. Here's how that looks in RStudio.
...
<details><summary>Click for matrix.</summary>
...
You can create multiple animation frames as a list of matrices with `frame_pixels()`. The last frame is used as a template for the next.
...
<details><summary>Click for list of matrices.</summary>
