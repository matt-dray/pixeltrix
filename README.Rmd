...
A matrix is returned when you've finished clicking and pressed <kbd>Esc</kbd>. Note that the colour palette is stored in the `colours` attribute, where the name of each element corresponds to its pixel state value in the matrix.
