...
#' A Shiny App to Create Matrices from Users' Pixel Art
#'
#' @return Nothing.
#'
#' @source [RStudio template](https://shiny.rstudio.com/gallery/image-interaction-basic.html)
#'
#' @export
#'
#' @examples \dontrun{pixeltrix()}
pixeltrix <- function() {
